...
export const blogPosts: BlogPost[] = [
    ...
    {
        id: 'p2',
        slug: 'nastilna-organayzer-polychka',
        title: 'Настільна органайзер-поличка',
        excerpt:
            'Ідеальний варіант для акуратного робочого місця. Легко збирається, може бути пофарбована або залишена натуральною.',
        category: 'DIY та натхнення',
    ...
    {
        id: 'p3',
        slug: 'nastilna-polychka-variatsii',
        title: 'Настільна органайзер-поличка: варіації',
        excerpt:
            'Від строгих ліній до абстрактних форм. Такий декор не тільки стильний, а й доступний для самостійного виготовлення.',
        category: 'DIY та натхнення',
